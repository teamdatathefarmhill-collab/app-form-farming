...
const SOP = {
  ...
  gramasi: {
    ...
    icon: "⚖️",
    color: "#1E88E5",
    description: "Form pencatatan berat daun (gramasi) tanaman sebagai indikator pertumbuhan.",
    steps: [
      {
        step: 1,
        title: "Pilih Greenhouse & Varian",
        detail: "Pilih GH dan varian tanaman yang akan diukur gramasinya.",
      },
      {
        step: 2,
        title: "Ambil Sampel Daun",
        detail: "Ambil daun sampel sesuai standar prosedur (daun ke-4/5 dari pucuk, pilih tanaman yang representatif).",
      },
      {
        step: 3,
        title: "Timbang & Input Berat",
        detail: "Timbang daun menggunakan timbangan digital. Masukkan hasil penimbangan dalam satuan gram.",
      },
      {
        step: 4,
        title: "Isi Jumlah Sampel",
        detail: "Masukkan jumlah daun/tanaman yang diambil sebagai sampel.",
      },
      {
        step: 5,
    ...
    notes: [
      "Pengukuran gramasi dilakukan pada waktu yang sama setiap pengukuran.",
      "Gunakan timbangan yang sudah dikalibrasi.",
      "Minimal 10 sampel per pengukuran untuk hasil yang valid.",
    ],
  },
